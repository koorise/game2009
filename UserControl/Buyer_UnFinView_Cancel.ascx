<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Buyer_UnFinView_Cancel.ascx.cs" Inherits="UserControl_Buyer_UnFinView_Cancel" %>
<%@ Register Src="CustomerService.ascx" TagName="CustomerService" TagPrefix="uc1" %>
<link href="style/unclosed-undo.css" rel="stylesheet" type="text/css" />
<link href="style/unclosed-sellundo.css" rel="stylesheet" type="text/css" />
<div class="cont">
    <h1>
        (仍)未成交的</h1>
    <div class="center">
