<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Buyer_FinView.ascx.cs" Inherits="UserControl_Buyer_FinView" %>
...
<div class="cont">
    ...
    <div class="center">
        ...
        <div>
            <asp:ImageButton ID="btn_getinfo" runat="server" ImageUrl="~/images/btn_tqzl.gif" OnClick="btn_getinfo_Click" width="85" height="24" hspace="5" vspace="10" />
            <asp:ImageButton ID="btn_assesssells" runat="server" ImageUrl="~/images/btn_pjmj.gif" OnClick="btn_assesssells_Click" width="85" height="24" hspace="5" vspace="10" />
            <asp:ImageButton ID="btn_assessservice" runat="server" ImageUrl="~/images/btn_pjkf.gif" OnClick="btn_assessservice_Click" width="85" height="24" hspace="5" vspace="10" />
            <asp:ImageButton ID="btn_gradeservice" runat="server" ImageUrl="~/images/btn_shfupf.gif" OnClick="btn_gradeservice_Click"
                    width="106" height="24" hspace="5" vspace="10" /></div>
        <div class="view">
