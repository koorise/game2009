<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Buyer_UnFinView_GoOn.ascx.cs" Inherits="UserControl_Buyer_UnFinView_GoOn" %>
<link href="style/unclosed-view.css" rel="stylesheet" type="text/css" />
<div class="cont">
    <h1>
        (仍)未成交的</h1>
    <div class="center">
        <div class="orgbox">
            ...
            <asp:ImageButton ID="btn_add1" runat="server" ImageUrl="~/images/btn_tgcj.gif" Width="65"
                Height="21" hspace="10" ImageAlign="absmiddle" OnClick="btn_add1_Click" />
        </div>
        <div class="view">
                                ...
                                <table border="0" align="center" cellpadding="5" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="red"><strong>
                                                <%# DataBinder.Eval(Container.DataItem, "orderType1").ToString()%></strong></span>
                                        </td>
                                        <td align="right" nowrap="nowrap">
                                            我的最高出价：
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" class="viewtd2">
                                            <asp:ImageButton ID="btn_add2" runat="server" ImageUrl="~/images/btn_tgcj.gif" Width="65"
                                                Height="21" hspace="10" ImageAlign="absmiddle" OnClick="btn_add1_Click" />
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <strong class="red">
                                                <%# DataBinder.Eval(Container.DataItem, "orderType1").ToString()%></strong><span
                                                    class="viewtd2">
                                                    <asp:ImageButton ID="btn_add3" runat="server" ImageUrl="~/images/btn_tgcj.gif" Width="65"
                                                        Height="21" hspace="10" ImageAlign="absmiddle" OnClick="btn_add1_Click" /></span>
                                        </td>
                                    </tr>
                                </table>
                                <p>
