                    ...
                    <dd>
                        <ul>
                            ...
                            <li class="noboder"><span class="lable">请输入您的答案：</span>
                                ...
                                <asp:HyperLink ID="link_forget" runat="server" Target="_blank" Text="忘记了密码提示问题？"></asp:HyperLink>&nbsp;<asp:HyperLink ID="link_mail" runat="server" Target="_blank" Text="找回注册邮箱"></asp:HyperLink>
                            </li>
                        </ul>
                    </dd>
                </dl>
                            ...
                            <tr>
                                <td valign="top" class="bluebox">
                                    <p id="orderInfo">
                                        ...
                                        成功后点击<strong><a href="~/Buyer_UnFin.aspx" target="_blank" class="red">我已买到的商品</a></strong>提取账号的详细资料
                                    </p>
                                    <p>
                                        &nbsp;</p>
                                    <div align="center">
