<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Buyer_UnFinView_Lost.ascx.cs" Inherits="UserControl_Buyer_UnFinView_Lost" %>
<%@ Register Src="CustomerService.ascx" TagName="CustomerService" TagPrefix="uc1" %>
<link href="style/unclosed-failed.css" rel="stylesheet" type="text/css" />
<div class="cont">
    <h1>
        (仍)未成交的</h1>
    <div class="center">
                            ...
                            <td class="bluebox">
                                <table border="0" align="center" cellpadding="5" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="viewtd1">
                                            <a href="#">
                                                <%# DataBinder.Eval(Container.DataItem, "UserName").ToString()%></a>&nbsp;<asp:Panel
                                                    ID="PromisePanel" runat="server">
                                                </asp:Panel>
                                        </td>
                                        <td align="right" nowrap="nowrap" class="viewtd1">
                                            交易方式：
