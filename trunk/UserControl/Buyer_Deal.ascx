<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Buyer_Deal.ascx.cs" Inherits="UserControl_Buyer_Deal" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cc1" %>
    <div class="cont"><asp:ScriptManagerProxy ID="ScriptManagerProxy1" runat="server">
