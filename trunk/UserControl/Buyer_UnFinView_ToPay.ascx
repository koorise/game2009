<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Buyer_UnFinView_ToPay.ascx.cs" Inherits="UserControl_Buyer_UnFinView_ToPay" %>
<%@ Register Src="CustomerService.ascx" TagName="CustomerService" TagPrefix="uc1" %>
<link href="style/unclosed-waitpay.css" rel="stylesheet" type="text/css" />
<div class="cont">
    <h1>
        (仍)未成交的</h1>
    <div class="center">
        <div class="orgbox">
            ...
            <asp:ImageButton ID="btn_add1" runat="server" ImageUrl="~/images/btn_waitpay.gif" Width="65"
                                        ...
                                        <td colspan="3">
                                            <strong class="red">
                                                <%# DataBinder.Eval(Container.DataItem, "orderType1").ToString()%></strong><span
                                                    class="viewtd2">
                                                    <asp:ImageButton ID="btn_add3" runat="server" ImageUrl="~/images/btn_waitpay.gif" Width="65"
