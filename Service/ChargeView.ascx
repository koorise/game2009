        ...
        <asp:DataList ID="MyOrderList1" Width="100%" border="0" CellSpacing="0" CellPadding="5"
            ...
            <ItemTemplate>
                <tr>
                    <td class="btd">
                        <div class="msg">
                            <a class="org" target="_self" href='ChargeView.aspx?runningid=<%# DataBinder.Eval(Container.DataItem, "runningid").ToString()%>'><%# DataBinder.Eval(Container.DataItem, "runningid").ToString()%></a><br />
